<div class="min-h-[calc(100vh-200px)] flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form action="/auth/entrar" method="POST">
            <div class="mb-4">
            ...
            <div class="flex items-center justify-between">
                <button class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full transition" 
                        type="submit">
                    Entrar
                </button>
            </div>
        ...
        <p class="text-center text-gray-600 text-sm mt-6">
            Ainda não tem conta? <a href="/auth/register" class="text-blue-600 font-bold hover:underline">Cadastre-se</a>
        </p>
    </div>
</div>